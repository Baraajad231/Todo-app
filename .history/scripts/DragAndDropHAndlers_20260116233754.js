...
// export const endDrag = () => {
//   if (!draggedTask) return;
//   console.log("the next el val is" + nextTask.innerText);
...
//     console.log(
//       "We move elemnent from " +
//         from +
//         " to the place " +
//         insertIndex +
//         " and this well be the last element"
//     );
//     console.log("--------------------");
//   } else {
...
//     console.log(
//       "We move elemnent from " + from + " to the place " + insertIndex
//     );
//     console.log("--------------------");
//   }
...
//   console.log("tasks lingth" + tasks.lengt);
