...
`;
  ...
  const metaRow = document.querySelector(".todo__list__row--meta");
  const filterRow = document.querySelector(".todo__list__row--filter");
  const controlRow = document.querySelector(".todo__list__row--control");
};
