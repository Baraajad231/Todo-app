...
export const renderConteolRow = (isDesktop) => {
  ...
  <li class="todo__list__row todo__list__row--control hidden" data-type="bc">
  ...
  <li class="todo__list__row todo__list__row--control data-type="mobile"">
            <div class="todo__items-left">
              <span class="todo__items-count">0</span>
              <span class="todo__items-text">items left</span>
            </div>
...
export const renderTasks = () => {
  ...
  const controlRow = document.querySelectorAll(".todo__list__row--control");
  controlRow.forEach((row) => {
    row.remove();
  });
  ...
  ShowHideControls();
  tasksElements += renderConteolRow(isDesktop);
